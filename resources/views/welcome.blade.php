...
<head>
    ...
    <title>Coming Soon - Synapsis Smart Booking</title>
...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="justify-center text-center pt-8 sm:justify-start sm:pt-0" style="color: #b90b00">
                <h1>Coming Soon</h1>
                <h2>Synapsis Smart Booking</h2>
