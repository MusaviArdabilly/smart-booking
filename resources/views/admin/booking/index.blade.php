                    ...
                    <table class="table table-bordered table-responsive display" id="table" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="status" id="status" data-id="{{ $booking->id }}" {{ $booking->status == 'checked-in' ? '' : 'disabled' }} data-old_status="{{ $booking->status }}">
                                        @if ($booking->status == 'booked')
                                        <option value="booked" selected>Booked</option>
                                        @elseif ($booking->status == 'canceled')
                                        <option value="cancelled" selected>Canceled</option>
                                ...
                                <td>
                                    <a href="#" class="btn btn-info btn-circle btn-sm mb-1" data-toggle="modal" data-target="#bookModal" data-id="{{ $booking->id }}" data-book_id="{{ $booking->book_id }}" data-user="{{ $booking->user->name }}" data-desk="{{ $booking->desk }}" data-date="{{ $booking->date }}" data-time="{{ $booking->time }}">
