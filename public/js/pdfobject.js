...
(function (root, factory) {
    ...
    */
    ...
    let generatePDFObjectMarkup = function (
        ...
        if (!omitInlineStyles) {
            let style =
                embedType === "embed" ? "overflow: auto;" : "border: none;";
    ...
    let embed = function (url, targetSelector, options) {
        ...
        let supportRedirect =
            typeof opt.supportRedirect === "boolean"
                ? opt.supportRedirect
                : false;
        let omitInlineStyles =
            typeof opt.omitInlineStyles === "boolean"
                ? opt.omitInlineStyles
                : false;
        let suppressConsole =
            typeof opt.suppressConsole === "boolean"
                ? opt.suppressConsole
                : false;
        let forceIframe =
        ...
        if (!targetNode) {
            return embedError(
                "Target element cannot be determined",
                suppressConsole
            );
        }
